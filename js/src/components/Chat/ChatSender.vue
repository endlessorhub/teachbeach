<template>
    <div>
        <div class="ChatGroup-SenderContent">
            ...
            <div class="SenderContent-about">
                ...
                <div class="SenderContent-about-ShareLinks">
                    <span :class="{'like-button':reply.is_liked}" @click="sendLike()">
                        <svg v-if="!reply.is_liked" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <span>
                        <input type="file" :id="reply.id" accept="image/png, image/gif, image/jpeg" class="hidden"
        ...
        <v-dialog v-model="blockUserDialog" width="290">
            <v-card>
                <v-card-text>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red" @click="blockSelectedUser(reply.user.id)">
                        Block
                    </v-btn>
                    <v-btn @click="blockUserDialog = !blockUserDialog">
                        Cancel
                    </v-btn>
                </v-card-actions>
            </v-card>
