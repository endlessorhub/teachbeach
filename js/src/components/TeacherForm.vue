<template>
  <form>
    ...
    <v-btn v-if="registerButton" @click="submit">Register</v-btn>
    <v-btn v-if="!registerButton" @click="back">Back</v-btn>
    <v-btn v-if="!registerButton && alreadyRegistered" @click="next">Next</v-btn>
    <v-btn v-if="!registerButton && !alreadyRegistered" @click="submit" :loading="isLoading" :disabled="isLoading">Start Teaching</v-btn>
