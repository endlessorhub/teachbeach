...
export default {
    ...
    computed: {
        ...
        interests() {
            return this.memberships.find(m => m.id === this.selectedMembership) ? this.memberships.find(m => m.id === this.selectedMembership).customInterestsField.split(',') || [] : []
        },
        skills() {
            return this.memberships.find(m => m.id === this.selectedMembership) ? this.memberships.find(m => m.id === this.selectedMembership).customSkillsField.split(',') || [] : []
        },
        levels() {
            return this.memberships.find(m => m.id === this.selectedMembership) ? this.memberships.find(m => m.id === this.selectedMembership).customLevelsField.split(',') || [] : []
        },
    },
    methods: {
        reload() {
