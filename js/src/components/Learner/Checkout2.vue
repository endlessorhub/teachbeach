        ...
        <v-flex xs12 lg6 class="text-xs-left">
          <v-layout align-top justify-center row wrap>
            ...
            <v-flex xs12 class="text-xs-left" v-if="!isSkipping">
                ...
                <v-btn :color="btnColor" class='pay-with-stripe' @click="submit" :loading="isLoading" :disabled="!complete && defaultCard == 'new_card'">
...
export default {
    ...
    created: function () {
        this.stripeConfig = this.$store.state.globals['stripe-key']
