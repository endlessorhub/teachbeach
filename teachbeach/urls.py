...
from main.views import (
    ...
    DiscussionAllListView, DiscussionChatAllowView, DiscussionBlockUserView, DiscussionCommentRemove
)
from . import views
...
urlpatterns = [
    ...
    url(r'^api/comment/delete/(\d*)$', csrf_exempt(DiscussionCommentRemove.as_view())),
